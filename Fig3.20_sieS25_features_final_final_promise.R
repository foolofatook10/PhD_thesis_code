...
my_colours <- c("#A6CEE3", "#1F78B4", "#FB9A99", "#E31A1C", "#FF7F00", "#D3D3D3")
...
# read in merged data
data <- read_csv(file.path(parent_dir, "Analysis/DESeq2_output/FINAL_sieS25_merged_DESeq2.csv"))
...
data_joined <- data_joined %>% filter(!RPFs_group %in% c("Totals down", "Totals up"))
...
png("\\\\data.beatson.gla.ac.uk/data/JETTLES/thesis_figures/sieS25_riboseq_features_all.png",
    res = 300, height = 3500, width = 3500)
...
png("\\\\data.beatson.gla.ac.uk/data/JETTLES/thesis_figures/wobble_base_identity_legend.png",
    res = 300, height = 200, width = 2000)
ggdraw(cowplot::get_legend(gplot_RSCU_groupboth))
dev.off()
...
png("\\\\data.beatson.gla.ac.uk/data/JETTLES/thesis_figures/sieS25_riboseq_features_RSCU_bothup_bothdown.png",
...
png("\\\\data.beatson.gla.ac.uk/data/JETTLES/thesis_figures/sieS25_riboseq_features_RSCU_RPFsupdown.png",
    res = 300, height = 1500, width = 1500)
RCSUs %>% 
  ggplot() +
