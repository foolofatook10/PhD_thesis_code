...
sieS25 <- 
  read_csv("\\\\data.beatson.gla.ac.uk/data/R11/James/CNOT3_Riboseq/Analysis/DESeq2_output/FINAL_sieS25_merged_DESeq2.csv")
...
sieS25 <- 
  sieS25 %>% inner_join(most_abundant_transcript, by = c("gene", "gene_sym"))
...
png("\\\\data.beatson.gla.ac.uk/data/JETTLES/thesis_figures/sieS25_riboseq_TOP_mRNAs.png", res = 300, height = 1250, width = 1250)
