...
leo <- 
  read.fasta("C:/Users/Jettles/OneDrive - University of Glasgow/Documents/panthera_leo/Panthera_leo.PanLeo1.0.cds.all.fa", whole.header = T)

sequences <- 
  unlist(getSequence(leo, as.string = T))
names <- unlist(getName.list(leo))
...
get_genes <- function(x){
  ...
  str_extract(x, pattern = "ENSPLOG\\d+\\.\\d+")
  #lapply(str_split(x, " "), function(x){x[[1]]})
}
...
write.fasta(sequences_split[1:5000], names = names_fasta[1:5000], file.out = "C:/Users/Jettles/OneDrive - University of Glasgow/Documents/leo_1_5000.fa")
write.fasta(sequences_split[5001:10000], names = names_fasta[5001:10000], file.out = "C:/Users/Jettles/OneDrive - University of Glasgow/Documents/leo_5000_10000.fa")
write.fasta(sequences_split[10001:15000], names = names_fasta[10001:15000], file.out = "C:/Users/Jettles/OneDrive - University of Glasgow/Documents/leo_10000_15000.fa")
write.fasta(sequences_split[15001:16817], names = names_fasta[15001:16817], file.out = "C:/Users/Jettles/OneDrive - University of Glasgow/Documents/leo_15000_20000.fa")


fyles <- paste0("C:/Users/Jettles/OneDrive - University of Glasgow/Documents/panthera_leo/output_maturePL", 
                c("1", "2", "3", "4"),
                ".fasta")
...
write.csv(transcripts_annotated, "C:/Users/Jettles/OneDrive - University of Glasgow/Documents/annotated_sequences/panthera_leo.csv")
...
png("\\\\data.beatson.gla.ac.uk/data/JETTLES/thesis_figures/P_leo.png",
    res = 300,
    height = 1000,
    width = 1500)
print(final_gplot)
