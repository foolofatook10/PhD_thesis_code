...
transcripts_annotated_by_SigP <- "\\\\data.beatson.gla.ac.uk/data/R11/James/sequences/drosophila_melanogaster.csv"
...
png("\\\\data.beatson.gla.ac.uk/data/JETTLES/thesis_figures/RSCU_fly.png",
