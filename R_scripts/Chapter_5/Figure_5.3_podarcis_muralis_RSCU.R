...
transcripts_annotated_by_SigP <- "C:/Users/Jettles/OneDrive - University of Glasgow/Documents/annotated_sequences/podarcis.csv"
...
png("\\\\data.beatson.gla.ac.uk/data/JETTLES/thesis_figures/RSCU_podarcis.png",
