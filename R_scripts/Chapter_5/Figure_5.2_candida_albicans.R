...
candida <- 
  read.fasta("C:/Users/Jettles/OneDrive - University of Glasgow/Documents/candida_albicans/Candida_albicans.GCA000182965v3.cds.all.fa", whole.header = T)

sequences <- 
  unlist(getSequence(candida, as.string = T))
names <- unlist(getName.list(candida))
...
get_genes <- function(x){
  ...
  str_remove(unlist(lapply(str_split(x, " "), function(x){x[[4]]})), "gene:")
}
...
write.fasta(sequences_split[1:5000], names = names_fasta[1:5000], file.out = "C:/Users/Jettles/OneDrive - University of Glasgow/Documents/candida_1_5000.fa")
write.fasta(sequences_split[5001:5872], names = names_fasta[5000:5872], file.out = "C:/Users/Jettles/OneDrive - University of Glasgow/Documents/candida_5000_10000.fa")



fyles <- paste0("C:/Users/Jettles/OneDrive - University of Glasgow/Documents/candida_albicans/output_matureCA", 
                c("1", "2"),
                ".fasta")
...
background %>% filter(position == 18 &signal_peptide == T) %>% arrange(-percent)

# ggsci::pal_npg("nrc")(4)
# "#E64B35FF" "#4DBBD5FF" "#00A087FF" "#3C5488FF"

png("\\\\data.beatson.gla.ac.uk/data/JETTLES/thesis_figures/C_albicans.png",
    res = 300,
    height = 1000,
    width = 1500)
print(final_gplot)
