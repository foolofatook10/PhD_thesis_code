...
neurospora <- 
  read.fasta("C:/Users/Jettles/OneDrive - University of Glasgow/Documents/neurospora_crassa/Neurospora_crassa.NC12.cds.all.fa", whole.header = T)

sequences <- 
  unlist(getSequence(neurospora, as.string = T))
names <- unlist(getName.list(neurospora))
...
write.fasta(sequences_split[1:5000], names = names_fasta[1:5000], file.out = "C:/Users/Jettles/OneDrive - University of Glasgow/Documents/neurospora_1_5000.fa")
write.fasta(sequences_split[5001:9418], names = names_fasta[5001:9418], file.out = "C:/Users/Jettles/OneDrive - University of Glasgow/Documents/neurospora_5000_10000.fa")


fyles <- paste0("C:/Users/Jettles/OneDrive - University of Glasgow/Documents/neurospora_crassa/output_matureNC", 
                c("1", "2"),
                ".fasta")
...
write.csv(transcripts_annotated, file = "C:/Users/Jettles/OneDrive - University of Glasgow/Documents/annotated_sequences/neruspora_crassa.csv")
...
png("\\\\data.beatson.gla.ac.uk/data/JETTLES/thesis_figures/N_crassa.png",
    res = 300,
    height = 1000,
    width = 1500)
print(final_gplot)
