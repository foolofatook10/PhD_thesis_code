...
transcripts_annotated_by_SigP <- "C:/Users/Jettles/OneDrive - University of Glasgow/Documents/annotated_sequences/panthera_leo.csv"
...
png("\\\\data.beatson.gla.ac.uk/data/JETTLES/thesis_figures/RSCU_panthera_leo.png",
