...
transcripts_annotated_by_SigP <- "\\\\data.beatson.gla.ac.uk/data/R11/James/sequences/features_mouse.csv"
...
features_mouse <- read_csv(transcripts_annotated_by_SigP) %>% select(ENSMUSG, ENSMUST, signal_sequence)

longest <- inner_join(longest, features_mouse, by = c("ENSMUSG", "ENSMUST")) %>% 
...
png("\\\\data.beatson.gla.ac.uk/data/JETTLES/thesis_figures/RSCU_mouse.png",
