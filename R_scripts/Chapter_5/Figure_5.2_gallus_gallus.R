...
gallus <- 
  read.fasta("C:/Users/Jettles/OneDrive - University of Glasgow/Documents/Gallus_gallus.bGalGal1.mat.broiler.GRCg7b.cds.all.fa", whole.header = T)

sequences <- 
  unlist(getSequence(gallus, as.string = T))
names <- unlist(getName.list(gallus))

get_transcripts <- function(x){
  
  str_extract(x, pattern = "^ENSGALT\\d+\\.\\d+")
  
}

get_genes <- function(x){
  
  str_extract(x, pattern = "ENSGALG\\d+\\.\\d+")
}
...
write.fasta(sequences_split[1:5000], names = names_fasta[1:5000], file.out = "C:/Users/Jettles/OneDrive - University of Glasgow/Documents/Gallus_gallus_1_5000.fa")
write.fasta(sequences_split[5001:10000], names = names_fasta[5001:10000], file.out = "C:/Users/Jettles/OneDrive - University of Glasgow/Documents/Gallus_gallus_5000_10000.fa")
write.fasta(sequences_split[10001:15000], names = names_fasta[10001:15000], file.out = "C:/Users/Jettles/OneDrive - University of Glasgow/Documents/Gallus_gallus_10000_15000.fa")
write.fasta(sequences_split[15001:15786], names = names_fasta[15001:15786], file.out = "C:/Users/Jettles/OneDrive - University of Glasgow/Documents/Gallus_gallus_15000_20000.fa")

fyles <- paste0("C:/Users/Jettles/OneDrive - University of Glasgow/Documents/gallus_gallus/output_mature", 
                c("_1", "_2", "_3", "_4"),
                ".fasta")
...
write.csv(transcripts_annotated, "C:/Users/Jettles/OneDrive - University of Glasgow/Documents/annotated_sequences/gallus_gallus.csv")
...
png("\\\\data.beatson.gla.ac.uk/data/JETTLES/thesis_figures/gallus_gallus.png",
    res = 300,
    height = 1000,
    width = 1500)
print(final_gplot)
...
png(filename = "\\\\data.beatson.gla.ac.uk/data/JETTLES/thesis_figures/CUG_DOG.png",
