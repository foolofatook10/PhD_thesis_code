...
lengths='28,29,30,31,32,33,34,35,36'
offsets='12,12,12,12,13,13,13,13,13'
...
lengths='21,22,23,24,25,26'
offsets='12,12,13,13,13,13'

#run counting script to generate <.counts> files

for filename in $RPF_filenames
do
counting_script.py -bam $BAM_dir/${filename}_pc_deduplicated_sorted.bam -fasta $most_abundant_fasta -len $lengths -offset $offsets -out_file ${filename}_pc_final_21nts.counts -out_dir $counts_dir &
done
wait