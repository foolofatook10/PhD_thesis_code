...
DESeq2data <- DESeq2data[rownames(DESeq2data) != "ENST00000527673.2",]
...
write_csv(DEseq2_output, file = file.path(parent_dir, "Analysis/DESeq2_output", paste0("FINAL_RPFs_", treatment, "_DEseq2_apeglm_LFC_shrinkage_without_eS25.csv")))
